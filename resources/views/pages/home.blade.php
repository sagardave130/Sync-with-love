            ...
            <div class="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="text-center lg:text-left order-2 lg:order-1">
                    <div
                        ...
                        <span class="text-xs font-bold text-gray-600 tracking-wide uppercase">Live Web App • No Login
                            Required</span>
                    </div>
                    ...
                    <p
                        ...
                        The interactive web game for couples to rediscover each other. Select a vibe, send the link to your
                        partner, and watch your answers sync.
                    </p>

                    <div
                        class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up delay-300">
                        <a href="#vibes"
                            class="px-10 py-5 text-lg rounded-2xl shadow-xl shadow-rose-500/20 hover:shadow-rose-500/40 transform hover:-translate-y-1 font-bold bg-gradient-to-r from-rose-600 to-rose-500 text-white transition-all active:scale-95 text-center">
                            Start New Game
                        </a>
                        <a href="{{ route('enter-code') }}"
                            class="px-10 py-5 text-lg rounded-2xl bg-white border-2 border-gray-100 hover:border-rose-200 text-gray-600 font-bold hover:bg-gray-50 transition-all active:scale-95 text-center">
                            Enter Code
                        </a>
                    </div>
            ...
            <div class="max-w-6xl mx-auto px-6 relative z-10">
                ...
                <div class="grid md:grid-cols-3 gap-10 relative">
                    ...
                    <div class="flex flex-col items-center text-center group">
                        ...
                        <p class="text-gray-500 text-sm leading-relaxed">Generate a private room link. No downloads. No
                            signup.</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center text-center group">
                        ...
                        <p class="text-gray-500 text-sm leading-relaxed">Answer questions on your own device. See who's
                            typing in real-time.</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center text-center group">
                        ...
                        <p class="text-gray-500 text-sm leading-relaxed">Answers unlock together. Compare, laugh, and spark
                            deep conversations.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="vibes" class="py-20 px-6 bg-slate-50 relative">
            ...
            <div class="text-center mb-14">
                ...
                <div class="inline-block bg-white border border-rose-100 rounded-full px-5 py-2 shadow-sm">
                    <p class="text-sm font-semibold text-rose-600 flex items-center gap-2">
                        Pick a vibe <span class="text-gray-400">→</span> Choose Play Now or Send Quiz <span
                            class="text-gray-400">→</span> Connect deeper ❤️
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
                @include('components.vibe-card', [
                    ...
                    'pattern' =>
                        'radial-gradient(circle, rgba(255, 255, 255, 0.4) 2px, transparent 3px); background-size: 20px 20px;',
                ])
                ...
                @include('components.vibe-card', [
                    ...
                    'gradientTo' => 'red-900',
                    'icon' =>
                        '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6"><path fill-rule="evenodd" d="M12.963 2.286a.75.75 0 00-1.071-.136 9.742 9.742 0 00-3.539 6.177 7.547 7.547 0 01-1.705-1.715.75.75 0 00-1.152-.082A9 9 0 1015.68 4.534a7.46 7.46 0 01-2.717-2.248zM15.75 14.25a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" clip-rule="evenodd"></path></svg>',
                    'pattern' =>
                        'repeating-linear-gradient(45deg, rgba(255, 255, 255, 0.1) 0px, rgba(255, 255, 255, 0.1) 10px, transparent 10px, transparent 20px); background-size: 20px 20px;',
                ])
                ...
                <div class="relative min-h-[320px] rounded-[2rem] overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl group bg-gray-900 flex flex-col"
                    ...
                    {{-- AI Topic Modal --}}
                    <div x-show="showAIModal" x-cloak @click.self="showAIModal = false"
                        ...
                        <div @click.away="showAIModal = false"
                            ...
                            <p class="text-gray-500 mb-6">Enter any topic and we'll generate personalized questions for
                                you.</p>
